...
export default {
  ...
  setup() {
    ...
    const getBlog1 = async () => {
      ...
      // const {data, msg} = await getWithOutParam(httpUrl + "/homepage/hotBlogs")
      //     .catch(error => {
      //       console.log(error)
      //     })
      //
